...
import fixBodyPostAltImgs from '../utils/fixBodyPostAltImgs';
...
const BlogPostTemplate = ({ data: { post }, pageContext }) => {
  ...
  const fixedHtml = fixBodyPostAltImgs(post.body.data.Body, post.body.data.childHtmlRehype.html);
