            ...
            <div>
                <div className="section-four-tile-wrapper">
                    ...
                    <div className="section-four-tile">
                        ...
                        <p className="section-four-tile-subtext">ELT in real-time for always up-to-date data in your warehouse of choice.</p>
                    </div>
                    <div className="section-four-tile">
                        <StaticImage
                            alt="data feature tile icon"
                        ...
                        <p className="section-four-tile-subtext">Seamlessly connect legacy systems to a modern hybrid cloud environment that’s fully extensible.</p>
                    </div>
                    <div className="section-four-tile">
                        <StaticImage
                            alt="data feature tile icon"
                        ...
                        <p className="section-four-tile-subtext">Power your data mesh in real time with tools that your entire company can use.</p>
                    </div>
                </div>
                <div className="section-four-tile-wrapper">
                    <div className="section-four-tile">
                        ...
                        <p className="section-four-tile-subtext">Understand the performance impact of your real-time analytical workloads.</p>
                    </div>
                    <div className="section-four-tile">
                        <StaticImage
                            alt="data feature tile icon"
                        ...
                        <p className="section-four-tile-subtext">Gain a unified view of your customers while your team interacts with them. Real-time with historical data.</p>
                    </div>
                    <div className="section-four-tile">
                        <StaticImage
                            alt="data feature tile icon"
                            ...
                            layout="fixed"
                        />
                        <h3 className="section-four-tile-title">Real-time analytics</h3>
                        <p className="section-four-tile-subtext">Use plain old SQL for streaming analytics on your data to react to business events in real time.</p>
                    </div>
                    <div className="section-four-tile">
                        <StaticImage
                            alt="data feature tile icon"
                            ...
                            layout="fixed"
                        />
                        <h3 className="section-four-tile-title">Data sharing</h3>
                        <p className="section-four-tile-subtext">Securely allow other users access to your realtime data products, and materialize them into whatever destination system they want.</p>
                    </div>
                </div>
                <div className="section-four-try-it-button-wrapper">
                    <p className="section-four-try-it-header-text">Use it free with hands-on support.  Scale without bounds.</p>
