...
export const ConnectorPage = ({
    ...
    return (
        <BackgroundImageWrapper>
            ...
            <div
                className="connector-link-bottom connector-section-wrapper"
                style={{ margin: 0, marginBottom: "6rem" }}
            >
                <ConnectorsLink
                    defaultSource={source_mapped?.id}
                    defaultDestination={dest_mapped?.id}
                />
            </div>
            <div className="connector-section-wrapper connector-section-background vertical-mobile">
                <div className="connector-section-content connector-center connector-section-mobile">
                    ...
                    <p className="connector-h2-subtext">
                        Estuary’s code-free streaming data operations platform
                        enables real-time data with history and the integrations
                        you need.
                    </p>
                </div>
