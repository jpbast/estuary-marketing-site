        ...
        <div className="global-footer-wrapper">
          <div className="global-footer-left">
            ...
            <div className="global-footer-subscribe">
              <input className="global-footer-input-email" placeholder="Email"></input>
              <button className="global-footer-input-button-submit">Submit</button>
            </div>
          </div>
        ...
        <div className="global-footer-bottom">
          ...
          <div className="global-footer-bottom-wrapper">
            ...
            <div className="global-footer-bottom-social">
              <StaticImage
                src="../images/slack-outline.svg" alt="slack logo"
                width={24}
                height={24}
                style={{
                  margin: "0 15px"
              ...
              />
              <StaticImage
                src="../images/github-outline.svg" alt="github logo"
                width={24}
                height={24}
                style={{
                  margin: "0 15px"
              ...
              />
              <StaticImage
                src="../images/linkedin-outline.svg" alt="linkedin logo"
                width={24}
                height={24}
                style={{
                  margin: "0 15px"
              ...
              />
              <StaticImage
                src="../images/twitter-outline.svg" alt="twitter logo"
                width={24}
                height={24}
                style={{
                  margin: "0 15px"
