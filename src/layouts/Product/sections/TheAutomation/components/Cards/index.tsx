    ...
    return (
        <Container>
            <ContainerCards>
                ...
                <Card title="Streaming Storage" description="Optionally connect your own cloud storage for cost-effective change history." $reverseDesktop>
                    <StaticImage
                        alt="icon-3"
            ...
            <ContainerCards>
                <Card title="Exactly Once" description="Idempotent pipelines provide assurance that your numbers are exactly correct." $reverse $reverseDesktop>
                    <StaticImage
                        alt="icon-4"
                ...
                <Card title="Share Data" description="Seamlessly share data with any other Estuary account enabling cross-provider data access." $reverse $reverseDesktop>
                    <StaticImage
                        alt="icon-6"
