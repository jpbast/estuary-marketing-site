...
import { Container, ContainerContent, ContainerImage, Title, LineBreak, Description, Topics, Topic, Observation } from "./style"
    ...
    return (
        <Container>
            ...
            <ContainerContent>
                ...
                <Topics>
                    <Topic>Ensure your BigQuery insights always reflect the latest data by connecting your databases to BigQuery with change data capture.</Topic>
